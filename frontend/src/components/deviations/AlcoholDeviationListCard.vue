...
const props = defineProps<{
  deviation: AlcoholDeviation
  canManage: boolean
}>()

const emits = defineEmits<{
  (e: 'edit', d: AlcoholDeviation): void
  (e: 'delete', id: number): void
  (e: 'update-status', id: number, status: AlcoholDeviationStatus): void
  (e: 'open', d: AlcoholDeviation): void
}>()

const deleteDialogOpen = ref(false)

const deviationTypeLabel: Record<AlcoholDeviationType, string> = {
...
const statusTone: Record<AlcoholDeviationStatus, 'danger' | 'warning' | 'ok'> = {
    ...
    <div class="card-top">
      ...
      <div v-if="canManage" class="card-actions" @click.stop>
        ...
        <AlertDialog v-model:open="deleteDialogOpen">
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Slette alkoholavvik?</AlertDialogTitle>
